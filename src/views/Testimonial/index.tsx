...
const Testimonial = () => {
  ...
  const handlePrev :any = useCallback(() => {
      ...
      <div className="relative w-full pb-16 md:w-11/12 lg:w-10/12 xl:w-8/12">
        <div className="w-full items-center md:flex">
          <div className="relative mb-12 w-full max-w-[310px] md:mb-0 md:mr-12 md:max-w-[250px] lg:mr-14 lg:max-w-[280px] 2xl:mr-16">
            <Image src={image} alt="image" className="w-full" width={400} height={400} />
          ...
          <div className="w-full">
            <div>
              <div className="mb-7">
                <Image  src={reviewImg} alt={reviewAlt}   width={400}
                height={400} />
              </div>

              <p className="mb-11 text-sm font-normal italic leading-[1.81] text-body-color dark:text-dark-6 sm:text-[22px]">
                {details}
              </p>
